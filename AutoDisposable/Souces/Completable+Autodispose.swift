...
public extension PrimitiveSequenceType where Trait == CompletableTrait, Element == Swift.Never {
     ...
     */
    public func subscribeWithAutoDispose(target: AutoDisposable, observer: @escaping (CompletableEvent) -> Void) {
     ...
     */
    public func subscribeWithAutoDispose(target: AutoDisposable, onCompleted: (() -> Void)? = nil, onError: ((Swift.Error) -> Void)? = nil) {
